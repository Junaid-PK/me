<template>
  <section id="contact" class="contact" aria-labelledby="contact-title">
    <div>
      <p class="eyebrow eyebrow--light">Start a conversation</p>
      <h2 id="contact-title">Have a difficult system or a useful idea?</h2>
    </div>
    <div class="contact-copy">
      <p>
        I’m interested in product engineering, backend architecture, developer tooling, and open-source collaboration.
      </p>
